...
export const requireGoogleAuth: RequestHandler = (req, res, next) => {
    if (!(req as AuthenticatedRequest).user?.accessToken) {
...
export const requireHubspotAuth: RequestHandler = async (req, res, next) => {
